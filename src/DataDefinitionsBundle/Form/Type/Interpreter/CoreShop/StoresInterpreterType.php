...
if (class_exists('OpenDxp\Ecommerce\Bundle\StoreBundle\Form\Type\StoreChoiceType')) {
    final class StoresInterpreterType extends AbstractType
    {
        public function buildForm(FormBuilderInterface $builder, array $options)
        {
            $builder
                ->add('stores', \OpenDxp\Ecommerce\Bundle\StoreBundle\Form\Type\StoreChoiceType::class, [
                    'multiple' => true,
                ])
                ->addModelTransformer(
                    new CallbackTransformer(
                        ...
                        function ($value) {
                            ...
                            foreach ($value['stores'] as $val) {
                                if ($val instanceof \OpenDxp\Ecommerce\Component\Core\Model\StoreInterface) {
