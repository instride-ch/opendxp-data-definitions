...
use Instride\Bundle\OpenDxpDataDefinitionsBundle\DataDefinitionsBundle\Form\Type\ImportRulesImportType;
use OpenSpout\Common\Entity\Row;
use OpenSpout\Reader\XLSX\Reader;
use OpenSpout\Writer\XLSX\Writer;
use OpenDxp\Bundle\AdminBundle\Controller\GDPR\AdminController;
...
class ImportRuleController extends AdminController
{
    public function importAction(Request $request, FormFactoryInterface $formFactory): JsonResponse
    {
        ...
        $file = $file->move(OPENDXP_SYSTEM_TEMP_DIRECTORY);
