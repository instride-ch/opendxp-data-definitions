...
use OpenDxp\Model\DataObject\Fieldcollection\Data\AbstractData as AbstractFieldCollection;
...
class FieldCollectionSetter implements SetterInterface, GetterInterface
{
    public function set(SetterContextInterface $context): void
    {
        ...
        $class = $config['class'];
        $keys = explode(',', $keys);
        $fieldCollectionClass = 'OpenDxp\Model\DataObject\Fieldcollection\Data\\' . ucfirst($class);
        $field = $keyParts[3];
        $mappedKeys = [];
