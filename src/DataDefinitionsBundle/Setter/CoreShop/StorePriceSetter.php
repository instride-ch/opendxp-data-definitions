...
if (interface_exists('OpenDxp\Ecommerce\Component\Store\Repository\StoreRepositoryInterface')) {
    class StorePriceSetter implements SetterInterface, GetterInterface
    {
        private $storeRepository;

        public function __construct(
            \OpenDxp\Ecommerce\Component\Store\Repository\StoreRepositoryInterface $storeRepository,
        ) {
        ...
        public function set(SetterContextInterface $context)
        {
            ...
            foreach ($config['stores'] as $store) {
                ...
                if (!$store instanceof \OpenDxp\Ecommerce\Component\Core\Model\StoreInterface) {
