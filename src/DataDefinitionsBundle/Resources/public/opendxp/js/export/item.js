...
opendxp.registerNS('opendxp.plugin.datadefinitions.export.item');
...
opendxp.plugin.datadefinitions.export.item = Class.create(opendxp.plugin.datadefinitions.definition.abstractItem, {
        ...
        this.configForm = new Ext.form.Panel({
            ...
            items: [
                ...
                },
                {
                    ...
                    valueField: 'provider',
                    store: opendxp.globalmanager.get('data_definitions_export_providers'),
                ...
                },
                {
                    ...
                    valueField: 'fetcher',
                    store: opendxp.globalmanager.get('data_definitions_fetchers'),
    ...
    reloadProviderSettings: function (provider) {
        if (this.providerSettings) {
            ...
            if (opendxp.plugin.datadefinitions.export_provider[provider] !== undefined) {
    ...
    updateProviderMapViews: function () {
        this.providerSettings.add(new opendxp.plugin.datadefinitions.export_provider[this.data.provider](this.data.configuration ? this.data.configuration : {}, this).getForm());
    ...
    getFetcherPanelLayout: function (type) {
        if (type) {
            ...
            if (opendxp.plugin.datadefinitions.fetchers[type]) {
                this.fetcher = new opendxp.plugin.datadefinitions.fetchers[type]();
    ...
    reloadColumnMapping: function () {
        if (this.mappingSettings) {
            ...
            this.mappingSettingsFieldsPanel = new opendxp.plugin.datadefinitions.export.fields(this.data);
