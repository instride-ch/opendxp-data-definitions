                    ...
                    var child = Ext.Object.merge(map,
                        {
                            ...
                            type: 'data',
                            leaf: true,
                            iconCls: 'opendxp_icon_' + fromColumn.fieldtype,
                            key: fromColumn.name,
                    ...
                    listeners: {
                        beforedrop: function (node, data, overModel, dropPosition, dropHandlers, eOpts) {
                            ...
                            if (target !== source) {
                                ...
                                var dialog = new opendxp.plugin.datadefinitions.export.configDialog();
            ...
            if (this.tree[keys[i]]) {
                if (this.tree[keys[i]].childs) {
                    ...
                    var baseNode = {
                        type: 'layout',
                        allowDrag: false,
                        iconCls: 'opendxp_icon_' + this.tree[keys[i]].nodeType,
                        text: text
                    };
