...
opendxp.registerNS('opendxp.plugin.datadefinitions.import.configDialog');

opendxp.plugin.datadefinitions.import.configDialog = Class.create({
    getConfigDialog: function (fromColumn, toColumn, record, config) {
        ...
        fieldSetItems.push(new Ext.form.ComboBox({
            ...
            store: opendxp.globalmanager.get('data_definitions_interpreters'),
        ...
        fieldSetItems.push(new Ext.form.ComboBox({
            ...
            store: opendxp.globalmanager.get('data_definitions_setters'),
            valueField: 'setter',
            displayField: 'setter',
            queryMode: 'local',
            listeners: {
    ...
    getInterpreterPanelLayout: function (type) {
        if (type) {
            ...
            if (opendxp.plugin.datadefinitions.interpreters[type]) {
                this.interpreter = new opendxp.plugin.datadefinitions.interpreters[type]();
    ...
    getSetterPanelLayout: function (type) {
        if (type) {
            ...
            if (opendxp.plugin.datadefinitions.setters[type]) {
                this.setter = new opendxp.plugin.datadefinitions.setters[type]();
