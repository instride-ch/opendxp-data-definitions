...
opendxp.registerNS('opendxp.plugin.datadefinitions.import.item');

opendxp.plugin.datadefinitions.import.item = Class.create(opendxp.plugin.datadefinitions.definition.abstractItem, {
        ...
        this.configForm = new Ext.form.Panel({
            ...
            items: [
                ...
                },
                {
                    ...
                    valueField: 'provider',
                    store: opendxp.globalmanager.get('data_definitions_providers'),
                ...
                },
                {
                    ...
                    displayField: 'loader',
                    valueField: 'loader',
                    store: opendxp.globalmanager.get('data_definitions_loaders'),
                ...
                },
                {
                    ...
                    valueField: 'cleaner',
                    store: opendxp.globalmanager.get('data_definitions_cleaners'),
                ...
                },
                {
                    ...
                    store: opendxp.globalmanager.get('data_definitions_persisters'),
                ...
                },
                {
                    ...
                    displayField: 'filter',
                    valueField: 'filter',
                    store: opendxp.globalmanager.get('data_definitions_filters'),
                ...
                },
                {
                    ...
                    displayField: 'runner',
                    valueField: 'runner',
                    store: opendxp.globalmanager.get('data_definitions_runners'),
    ...
    reloadProviderSettings: function (provider) {
        if (this.providerSettings) {
            ...
            if (opendxp.plugin.datadefinitions.provider[provider] !== undefined) {
    ...
    updateProviderMapViews: function () {
        this.providerSettings.add(new opendxp.plugin.datadefinitions.provider[this.data.provider](this.data.configuration ? this.data.configuration : {}, this).getForm());
                                ...
                                items: [
                                    {
                                        ...
                                        renderer: function (val, metadata) {
                                            ...
                                            if (rec) {
                                                metadata.tdCls = 'opendxp_icon_' + rec.data.fieldtype + ' td-icon';
                                                ...
                                                change: function (combo, newValue, oldValue, eOpts) {
                                                    ...
                                                    if (gridRecord.length > 0) {
                                                        ...
                                                        if (fromColumn && toColumn) {
                                                            var dialog = new opendxp.plugin.datadefinitions.import.configDialog();
