...
opendxp.registerNS('opendxp.plugin.datadefinitions.setters.objectbrick');

opendxp.plugin.datadefinitions.setters.objectbrick = Class.create(opendxp.plugin.datadefinitions.setters.abstract, {
