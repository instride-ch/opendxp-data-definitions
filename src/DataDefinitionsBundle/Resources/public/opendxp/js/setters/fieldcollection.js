...
opendxp.registerNS('opendxp.plugin.datadefinitions.setters.fieldcollection');

opendxp.plugin.datadefinitions.setters.fieldcollection = Class.create(opendxp.plugin.datadefinitions.setters.abstract, {
