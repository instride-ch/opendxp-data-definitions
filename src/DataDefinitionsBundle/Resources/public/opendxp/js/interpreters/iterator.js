...
opendxp.registerNS('opendxp.plugin.datadefinitions.interpreters.iterator');

opendxp.plugin.datadefinitions.interpreters.iterator = Class.create(opendxp.plugin.datadefinitions.interpreters.abstract, {
    getStore: function () {
