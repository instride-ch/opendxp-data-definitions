...
opendxp.registerNS('opendxp.plugin.datadefinitions.interpreters.asset_url');

opendxp.plugin.datadefinitions.interpreters.asset_url = Class.create(opendxp.plugin.datadefinitions.interpreters.abstract, {
