...
opendxp.registerNS('opendxp.plugin.datadefinitions.interpreters.nested');

opendxp.plugin.datadefinitions.interpreters.nested = Class.create(opendxp.plugin.datadefinitions.interpreters.abstract, {
    getStore: function () {
        return opendxp.globalmanager.get('data_definitions_interpreters');
    },

    getClassItem: function () {
        return opendxp.plugin.datadefinitions.interpreters;
    },
    ...
    addInterpreter: function (type, fromColumn, toColumn, record, config) {
        ...
        var container = new opendxp.plugin.datadefinitions.interpreters.nestedcontainer(this, type, item);
