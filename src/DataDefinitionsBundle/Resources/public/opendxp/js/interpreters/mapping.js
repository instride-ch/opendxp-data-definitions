...
opendxp.registerNS('opendxp.plugin.datadefinitions.interpreters.mapping');

opendxp.plugin.datadefinitions.interpreters.mapping = Class.create(opendxp.plugin.datadefinitions.interpreters.abstract, {
