...
opendxp.registerNS('opendxp.plugin.datadefinitions.interpreters.nestedcontainer');

opendxp.plugin.datadefinitions.interpreters.nestedcontainer = Class.create({
    parent: {},
    data: {},
    ...
    getTopBar: function (name, index, parent, data) {
        ...
        var items = [{
            ...
            handler: function (blockId, parent, container, namespace) {
                ...
                var index = opendxp.plugin.datadefinitions.interpreters.nestedcontainer.prototype.getIndex(blockElement, container);
                var tmpContainer = opendxp.viewport;
