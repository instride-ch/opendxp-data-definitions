...
opendxp.registerNS('opendxp.plugin.datadefinitions.interpreters.conditional');

opendxp.plugin.datadefinitions.interpreters.conditional = Class.create(opendxp.plugin.datadefinitions.interpreters.abstract, {
    ...
    getTrueInterpreterPanelLayout: function (type, fromColumn, toColumn, record, parentConfig, config) {
        if (type) {
            ...
            if (opendxp.plugin.datadefinitions.interpreters[type]) {
                this.trueInterpreter = new opendxp.plugin.datadefinitions.interpreters[type]();
    ...
    getFalseInterpreterPanelLayout: function (type, fromColumn, toColumn, record, parentConfig, config) {
        if (type) {
            ...
            if (opendxp.plugin.datadefinitions.interpreters[type]) {
                this.falseInterpreter = new opendxp.plugin.datadefinitions.interpreters[type]();
