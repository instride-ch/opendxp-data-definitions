...
opendxp.registerNS('opendxp.plugin.datadefinitions.getters.objectbrick');

opendxp.plugin.datadefinitions.getters.objectbrick = Class.create(opendxp.plugin.datadefinitions.setters.objectbrick, {
