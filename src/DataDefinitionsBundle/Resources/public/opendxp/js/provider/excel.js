...
opendxp.registerNS('opendxp.plugin.datadefinitions.provider.excel');

opendxp.plugin.datadefinitions.provider.excel = Class.create(opendxp.plugin.datadefinitions.provider.abstractprovider, {
    getItems: function () {
        return [{
            xtype: 'textarea',
