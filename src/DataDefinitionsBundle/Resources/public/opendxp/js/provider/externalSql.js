...
opendxp.registerNS('opendxp.plugin.datadefinitions.provider.external_sql');

opendxp.plugin.datadefinitions.provider.external_sql = Class.create(opendxp.plugin.datadefinitions.provider.abstractprovider, {
    getItems: function () {
        return [{
            xtype: 'textfield',
            name: 'host',
