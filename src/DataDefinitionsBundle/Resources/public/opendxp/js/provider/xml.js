...
opendxp.registerNS('opendxp.plugin.datadefinitions.provider.xml');

opendxp.plugin.datadefinitions.provider.xml = Class.create(opendxp.plugin.datadefinitions.provider.abstractprovider, {
    getItems: function () {
        return [{
            xtype: 'textfield',
            name: 'xPath',
