...
opendxp.registerNS('opendxp.plugin.datadefinitions.getters.fieldcollection');

opendxp.plugin.datadefinitions.getters.fieldcollection = Class.create(opendxp.plugin.datadefinitions.setters.fieldcollection, {
