...
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Repository;
...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('opendxp_data_definitions');
            ...
            ->arrayNode('opendxp_admin')
                ...
                ->children()
                    ...
                    ->arrayNode('install')
                        ...
                        ->children()
                            ->scalarNode('sql')
                                ->defaultValue(['@OpenDxpDataDefinitionsBundle/Resources/install/opendxp/sql/data.sql'])
                            ->end()
                        ->end()
                    ->end()
                ->end()
