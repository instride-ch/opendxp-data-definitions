...
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Event\EventDispatcherInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Exception\DoNotSetException;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Exception\UnexpectedValueException;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Filter\FilterInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Interpreter\InterpreterInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Messenger\ImportRowMessage;
...
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Model\ParamsAwareInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Persister\PersisterInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Provider\ArrayImportDataSet;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Provider\ImportDataSet;
...
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Runner\ImportStartFinishRunnerInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Runner\RunnerInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Runner\SaveRunnerInterface;
use Instride\Bundle\OpenDxpDataDefinitionsBundle\Runner\SetterRunnerInterface;
...
final class Importer implements ImporterInterface, AsyncImporterInterface
{
    ...
    public function processSuccessfullImport(ImportDefinitionInterface $definition, $params, $objectIds, $exceptions): void
    {
    ...
    private function getData(ImportDefinitionInterface $definition, array $params): ImportDataSetInterface
    {
    ...
    private function getObject(
        ...
        $classObject = '\OpenDxp\Model\DataObject\\' . ucfirst($class);
