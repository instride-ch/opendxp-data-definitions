...
namespace Instride\Bundle\OpenDxpDataDefinitionsBundle\Behat\Context\Configuration;
...
final class ServiceConfigurationContext implements Context
{
    ...
    private function collectReferences(string $pattern): array
    {
        ...
        foreach (glob(self::CONFIG_DIR . '/{,services/,services/contexts/}*.yaml', \GLOB_BRACE) ?: [] as $file) {
